...
(function () {
    ...
    var translations = {
        en: {
            ...
            'home.features.score.body': 'Load your trained model and a customer list for instant churn risk scores and clear risk tiers — so you can see who needs attention now.',
            ...
            'home.usecases.outro': '<b>Any yes/no customer outcome you can export as a CSV.</b>',
            ...
            'train.features_source_cols': 'source columns',
            ...
            'doc.workflow.li2': '<b><a href="#/predict">Score</a></b> — load a trained model and a new customer list to get a churn score and a risk tier for each customer.',
            ...
            'doc.scoring.li2': '<b>Accuracy evaluation.</b> If the scored CSV still contains the true churn column, the app computes overall accuracy and a full <b>confusion matrix</b> (predicted vs. actual).',
        ...
        fr: {
            ...
            'home.features.score.body': 'Chargez votre modèle entraîné et une liste de clients pour obtenir instantanément des scores de risque de churn et des tranches de risque claires — afin d\u2019identifier qui nécessite une attention immédiate.',
            ...
            'home.usecases.outro': '<b>Tout résultat client binaire (oui/non) exportable en CSV.</b>',
            ...
            'train.features_source_cols': 'colonnes sources',
            ...
            'doc.workflow.li2': '<b><a href="#/predict">Scorer</a></b> — chargez un modèle entraîné et une nouvelle liste de clients pour obtenir un score de churn et une tranche de risque pour chaque client.',
            ...
            'doc.scoring.li2': '<b>Évaluation de la précision.</b> Si le CSV scoré contient encore la vraie colonne de churn, l\u2019application calcule la précision globale et une <b>matrice de confusion</b> complète (prédit vs. réel).',
        ...
        es: {
            ...
            'home.features.score.body': 'Carga tu modelo entrenado y una lista de clientes para obtener al instante puntuaciones de riesgo de churn y tramos de riesgo claros — y ver a quién atender ahora.',
            ...
            'home.usecases.outro': '<b>Cualquier resultado binario de cliente (sí/no) exportable como CSV.</b>',
            ...
            'train.features': 'Variables:',
            'train.features_source_cols': 'columnas de origen',
            ...
            'doc.workflow.li2': '<b><a href="#/predict">Puntuar</a></b> — carga un modelo entrenado y una nueva lista de clientes para obtener una puntuación de churn y un tramo de riesgo para cada uno.',
            ...
            'doc.scoring.li2': '<b>Evaluación de precisión.</b> Si el CSV puntuado aún contiene la columna de churn real, la aplicación calcula la precisión global y una <b>matriz de confusión</b> completa (predicho vs. real).',
